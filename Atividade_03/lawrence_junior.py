...
def avalia_modelo(resultados_reais, resultados_preditos):
    ...
    ### Seu código inicia aqui ###	
    resultado[0] = accuracy_score(resultados_reais, resultados_preditos)
    resultado[1] = precision_score(resultados_reais, resultados_preditos)
    resultado[2] = recall_score(resultados_reais, resultados_preditos)
    resultado[3] = f1_score(resultados_reais, resultados_preditos)
    ### Seu código termina aqui ###
    return resultado
